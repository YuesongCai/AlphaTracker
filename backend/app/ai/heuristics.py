...
ALIAS_MAP = {
    ...
    "goldman": "GS", "berkshire": "BRK.B",
    # AI infra chain + common coverage names
    "coreweave": "CRWV", "nebius": "NBIS", "lumentum": "LITE",
    "coherent": "COHR", "fabrinet": "FN", "globalfoundries": "GFS",
    "tower semiconductor": "TSEM", "core scientific": "CORZ",
    "applied digital": "APLD", "bloom energy": "BE", "iren": "IREN",
    "sandisk": "SNDK", "western digital": "WDC", "seagate": "STX",
    "sk hynix": "SK海力士", "microstrategy": "MSTR", "strategy inc": "MSTR",
    "robinhood": "HOOD", "unitedhealth": "UNH", "interactive brokers": "IBKR",
    "spacex": "SpaceX", "starlink": "SpaceX", "vertiv": "VRT",
    "constellation energy": "CEG", "vistra": "VST", "arista": "ANET",
    "英伟达": "NVDA", "苹果": "AAPL",
